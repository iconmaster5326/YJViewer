...
ENUM_TRANSLATED: typing.Dict[enum.Enum, str] = {
    ...
    ygojson.CardRarity.RARE_BLUE: "R (blue)",
    ygojson.CardRarity.RARE_COPPER: "R (copper)",
    ygojson.CardRarity.RARE_GREEN: "R (green)",
    ygojson.CardRarity.RARE_PURPLE: "R (purple)",
    ygojson.CardRarity.RARE_RED: "R (red)",
    ygojson.CardRarity.RARE_WEDGEWOOD: "R (wedgewood)",
    ygojson.CardRarity.SUPER: "SR",
    ygojson.CardRarity.ULTRA: "UR",
    ygojson.CardRarity.ULTRA_BLUE: "UR (blue)",
    ygojson.CardRarity.ULTRA_GREEN: "UR (green)",
    ...
    ygojson.CardRarity.SECRET_BLUE: "ScRBlue",
